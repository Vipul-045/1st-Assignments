...
2. If you don't, you can copy these over to repl.itwont be autom and run it there. Tests ated there so you will have to make use judgement to ensure if your code is correct
